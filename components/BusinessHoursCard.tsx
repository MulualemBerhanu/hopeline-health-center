  ...
  return (
    <div className="bg-gradient-to-br from-white via-hopeline-cream to-white rounded-3xl p-10 shadow-large border-2 border-gray-100 hover:shadow-colored transition-all duration-300 relative overflow-hidden group">
      ...
      <div className="relative z-10">
        ...
        {/* 24/7 Crisis Support Highlight */}
        <div className="bg-gradient-to-r from-hopeline-teal/10 to-hopeline-sky/10 rounded-2xl p-6 border-2 border-hopeline-teal/20 relative overflow-hidden">
          <div className="absolute top-0 right-0 w-32 h-32 bg-hopeline-teal/5 rounded-full blur-2xl"></div>
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-2">
              <div className="bg-hopeline-teal rounded-lg p-2">
                <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                </svg>
              </div>
              <p className="text-hopeline-teal font-bold text-xl">24/7 Crisis Management</p>
            </div>
            <p className="text-gray-700 text-sm ml-11">Available for current patients - Call anytime</p>
          </div>
        </div>
      </div>
    </div>
